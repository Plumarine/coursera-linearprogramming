...
set ruler
set runtimepath=~/.vim/bundle/vundle,~/.vim/bundle/Wombat,~/.vim/bundle/The-NERD-tree,~/.vim/bundle/Conque-Shell,~/.vim/bundle/surround.vim,~/.vim/bundle/vim-scala,~/.vim,/Applications/MacVim.app/Contents/Resources/vim/vimfiles,/Applications/MacVim.app/Contents/Resources/vim/runtime,/Applications/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/vundle/,~/.vim/bundle/vundle/after,~/.vim/bundle/Wombat/after,~/.vim/bundle/The-NERD-tree/after,~/.vim/bundle/Conque-Shell/after,~/.vim/bundle/surround.vim/after,~/.vim/bundle/vim-scala/after
set shiftwidth=4
set showcmd
set noshowmode
set sidescroll=1
...
silent only
cd ~/Workspace/Coursera/linearprogramming/part2TestCases
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 session.vim
badd +13 code/main.py
badd +1 code/dictionary.py
badd +19 code/solver.py
badd +39 code/pivot.py
badd +9 Makefile
badd +1 unitTests/dict5.out
badd +0 make
badd +0 :make
badd +0 bash\ -\ 1
badd +13 ~/.gvimrc
silent! argdel *
edit code/dictionary.py
...
exe 'vert 3resize ' . ((&columns * 92 + 91) / 182)
exe '4resize ' . ((&lines * 16 + 26) / 53)
exe 'vert 4resize ' . ((&columns * 92 + 91) / 182)
exe '5resize ' . ((&lines * 16 + 26) / 53)
exe 'vert 5resize ' . ((&columns * 92 + 91) / 182)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let s:l = 104 - ((15 * winheight(0) + 12) / 25)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 64 - ((10 * winheight(0) + 8) / 17)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
64
